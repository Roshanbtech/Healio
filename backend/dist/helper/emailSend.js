...
const emailSend = async (data) => {
    ...
    `;
        // Send emails
        await (0, emailConfig_1.default)(data.patientId.email, "HEALIO: Your Appointment Confirmation", "", patientBody);
        await (0, emailConfig_1.default)(data.doctorId.email, "HEALIO: New Appointment Notification", "", doctorBody);
    }
    catch (error) {
