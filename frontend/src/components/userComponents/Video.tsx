...
//       localStreamRef.current = null;
//       setLocalStream(null);
//       console.log("User: Local stream stopped.");
//     }
//   };
...
//       });
//       setIsMuted(!isMuted);
//       console.log("User: Toggled mute. Now muted:", !audioTracks[0].enabled);
//     }
//   };
...
//       console.log("User: Toggled video. Video off:", !videoTracks[0].enabled);
//     }
//   };
...
//         <div className="flex-1 flex flex-col md:flex-row p-6 relative overflow-hidden bg-gradient-to-br from-green-50 to-white">
//           <div 
//             className={`${callActive ? "w-full md:w-3/4 h-full" : "w-full h-full"} relative rounded-xl overflow-hidden shadow-lg`}
//             style={{
//               boxShadow: "0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06), inset 0 0 0 1px rgba(220,38,38,0.1)"
//             }}
//           >
...
//             ) : (
//               <div className="w-full h-full flex items-center justify-center bg-gray-800 rounded-xl">
//                 <div className="text-center px-4" style={{ background: "linear-gradient(135deg, #1a1a1a, #2d3748)" }}>
//                   <div className="py-12 px-8">
//                     <Camera size={64} className="mx-auto text-red-100 mb-6 opacity-70" />
//                     <p className="text-white text-xl mb-4 font-light">Waiting for doctor to connect...</p>
//                     <p className="text-red-100 text-sm opacity-70">Your camera and microphone are ready</p>
...
//             {/* Local Video (User) - Picture in Picture */}
//             <div className="absolute bottom-4 right-4 w-1/4 h-1/4 md:w-1/5 md:h-1/5 rounded-lg overflow-hidden transition-all duration-300 border-2 border-red-100"
//               style={{ boxShadow: "0 4px 12px rgba(0, 0, 0, 0.15)" }}
//             >
//               <video 
//                 ref={localVideoRef} 
...
//                 autoPlay 
//                 playsInline 
//                 className={`w-full h-full object-cover bg-gray-900 ${isVideoOff ? 'opacity-50' : 'opacity-100'}`}
//               />
//               {isVideoOff && (
