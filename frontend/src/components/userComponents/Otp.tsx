      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-[1000px] bg-white rounded-[20px] shadow-lg flex overflow-hidden">
                ...
                <div className="flex gap-2 justify-center">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      onPaste={handlePaste}
                      className="w-12 h-12 text-center text-xl font-semibold rounded-md bg-[#f0fdf4] border-0 focus:ring-2 focus:ring-green-100"
          ...
          <div className="hidden md:block w-1/2 p-6">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-01-21%20214907-oCDuifnuKfQlhXAGJ1tvWp3NrmLhBi.png"
