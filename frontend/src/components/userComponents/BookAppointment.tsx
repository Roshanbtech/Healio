...
const BookAppointment: React.FC = () => {
  ...
  const paymentBreakdown: PaymentBreakdown = {
    ...
    taxCharges: 100,
    discount: appliedCoupon?.discountAmount ?? 50,
    payable: (docInfo?.fees ?? 1200) + 100 - (appliedCoupon?.discountAmount ?? 50),
  };
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-700 p-6 rounded-t-lg">
          <div className="flex items-center gap-6">
            ...
            <div className="text-white">
              ...
              <p className="text-sm mt-2 opacity-90">Experience: {docInfo.experience} years</p>
            </div>
          </div>
        </div>
        <div className="p-8 border-b border-gray-100">
          <div className="flex justify-between mb-4">
            <div className="text-center bg-green-100 p-4 rounded-lg shadow-sm flex-1 mr-4">
              <p className="font-semibold text-gray-700 mb-1">Appointment Date</p>
            ...
            <div className="text-center bg-green-100 p-4 rounded-lg shadow-sm flex-1">
              <p className="font-semibold text-gray-700 mb-1">Appointment Time</p>
              <p className="text-lg font-medium text-gray-900">
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className={`border rounded-lg p-4 cursor-pointer transition-all ${selectedPayment === "razorpay" ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-red-300"}`}
              ...
              <div className={`border rounded-lg p-4 cursor-pointer transition-all ${selectedPayment === "account" ? "border-red-500 bg-red-50" : "border-gray-200 hover:border-red-300"}`}
          ...
          <div className="mb-8 bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <div>
              <div className="text-sm text-gray-600 mb-2">Available Coupons:</div>
              <div className="flex flex-wrap gap-2">
                {coupons.length > 0 ? (
                  coupons.map((coupon) => (
                    ...
                    >
                      <div className="font-medium text-red-600">{coupon.code}</div>
          ...
          <div className="mb-8 bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <div className="space-y-3">
              <div className="flex justify-between py-2">
                ...
                <span className="font-medium">₹{paymentBreakdown.consultingFees}</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-gray-600">Tax Charges</span>
                <span className="font-medium">₹{paymentBreakdown.taxCharges}</span>
              </div>
              <div className="flex justify-between py-2">
                <span className="text-gray-600">Discount</span>
                <span className="font-medium text-green-600">-₹{paymentBreakdown.discount}</span>
              </div>
              <div className="border-t border-gray-300 pt-3 mt-3">
                <div className="flex justify-between font-bold text-lg">
                  <span>Total Payable</span>
                  <span className="text-red-600">₹{paymentBreakdown.payable}</span>
                </div>
              </div>
            </div>
          </div>
