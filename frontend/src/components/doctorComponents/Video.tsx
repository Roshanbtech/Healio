...
const DoctorVideoCall: React.FC<DoctorVideoCallProps> = ({
  ...
  useEffect(() => {
    ...
    socket.on("video:accepted", (data) => {
      if (data.chatId === chatId && data.callerId === userId) {
      ...
      >
        ...
        <div className="p-5 bg-gradient-to-r from-gray-50 to-gray-100 flex justify-center items-center space-x-6 border-t border-green-100 rounded-b-2xl">
          <button
            ...
            style={{
              boxShadow: isMuted ? "0 4px 10px rgba(220, 38, 38, 0.3)" : "0 4px 10px rgba(0, 0, 0, 0.1)",
            }}
          ...
          {callActive ? (
            ...
            <button
              ...
              style={{
                boxShadow: isConnecting ? "0 4px 10px rgba(0, 0, 0, 0.1)" : "0 4px 14px rgba(0, 0, 0, 0.15)",
              }}
          ...
          <button
            ...
            style={{
              boxShadow: isVideoOff ? "0 4px 10px rgba(220, 38, 38, 0.3)" : "0 4px 10px rgba(0, 0, 0, 0.1)",
            }}
