...
// // Custom Button Component (same as in AppointmentsList)
...
// // Appointment Interface (similar to the one in AppointmentsList)
...
// // PrescriptionForm Props Interface
...
//     // Check if medicines are filled properly
...
//     // Remove empty lab tests
//     const filteredLabTests = labTests.filter((test) => test.trim() !== "");
...
//     try {
//       // For signature, in a real app you would upload to S3 and get a URL back
//       // For this example, we'll just pass the dataURL directly
//       // In a production app, you'd need to implement the S3 upload separately
...
//         `/doctor/prescriptions/${appointment._id}`,
//         prescriptionData
//       );
...
//             {/* Patient: {appointment.patientId.name} | Appointment ID: {appointment.appointmentId} */}
//           </p>
//         </div>
...
//               You won't be able to edit this prescription after submission. Are
