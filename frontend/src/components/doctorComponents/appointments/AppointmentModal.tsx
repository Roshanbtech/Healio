...
const AppointmentModal: React.FC<AppointmentModalProps> = ({ appointment, modalViewType, onClose }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="bg-white rounded-xl shadow-2xl z-50 max-w-lg w-full overflow-hidden">
          ...
          {modalViewType === "prescription" ? (
            <>
              <div className="mb-3">
                ...
                <p className="text-base">{appointment.patientId.name}</p>
              </div>
              <div className="mb-3 grid grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-semibold">Date:</p>
                  <p className="text-base">{formatAppointmentDate(appointment.date)}</p>
                </div>
                <div>
              ...
              <div>
                ...
                <p className="text-base">{appointment.prescription}</p>
              </div>
            </>
          ) : modalViewType === "previousReport" ? (
            <>
              ...
              <div className="mb-4">
                <p className="text-lg font-semibold">Previous Medical Records:</p>
              </div>
                    ...
                    >
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-base">{record.condition || "N/A"}</p>
                        </div>
                        <div>
                        ...
                        <div className="col-span-2">
                          ...
                          <p className="text-base">{record.notes || "N/A"}</p>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <>
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  ...
                  <p className="text-base">{appointment.appointmentId}</p>
                </div>
                <div>
                  <p className="text-sm font-semibold">Patient:</p>
                  <p className="text-base">{appointment.patientId.name}</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  ...
                  <p className="text-base">{appointment.patientId.phone}</p>
                </div>
                <div>
                  <p className="text-sm font-semibold">Email:</p>
                  <p className="text-base">{appointment.patientId.email}</p>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  ...
                  <p className="text-base">{appointment.status}</p>
                </div>
                <div>
                  <p className="text-sm font-semibold">Payment:</p>
                  <p className="text-base">{appointment.paymentStatus || "N/A"}</p>
                </div>
              </div>
              <div className="mb-3">
                <p className="text-sm font-semibold">Reason:</p>
                <p className="text-base">{appointment.reason || "Not specified"}</p>
              </div>
              {appointment.fees && (
                <div className="mb-3">
                  <p className="text-sm font-semibold">Fees:</p>
                  <p className="text-base">₹{appointment.fees}</p>
                </div>
              )}
            </>
          )}
        ...
        <div className="p-4 border-t border-green-200 flex justify-end">
          <CustomButton variant="solid" size="sm" onClick={onClose}>
            Close
          </CustomButton>
        </div>
      </div>
