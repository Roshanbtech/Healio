...
const About = () => {
  ...
  const doctors = [
    {
      ...
      description:
        "Board certified with over 10 years of experience in family medicine and primary care.",
      specialty: "Specialized in Family Medicine",
    ...
    },
    {
      ...
      title: "Cardiologist",
      description:
        "Specialized in cardiovascular health with expertise in preventive cardiac care.",
      specialty: "Expert in Cardiovascular Health",
    ...
    },
    {
      ...
      specialty: "Child Healthcare Specialist",
    ...
    },
    {
      ...
      title: "Neurologist",
      description:
        "Specialized in treating neurological disorders with a patient-centered approach.",
  ...
  return (
    <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 py-24 relative z-10">
          <div className="max-w-2xl">
            ...
            <p className="text-xl md:text-2xl max-w-2xl text-white opacity-90">
              Your trusted healthcare partner for personalized medical care and
              wellness solutions.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                  <p className="text-white font-medium">
                    Experience Healio's approach to healthcare
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:w-1/2">
            ...
            <p className="text-gray-700 mb-6 text-lg">
              Healio is founded by Dr. Sarah Peterson & Dr. James Patel, both
              Board Certified doctors with over 15 years of experience in
              healthcare. We understand the challenges individuals face when it
              comes to health and finding approachable and trustworthy medical
              care.
            </p>
            <p className="text-gray-700 mb-8 text-lg">
              Healio aims to provide an in-depth look at Healthcare. We use
              innovative ideas for practicing our Profession in keeping the
              patient informed and involved, providing personalized care through
              diagnostics, monitoring, and health education.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mt-6">
              ...
              provide you with the best healthcare experience possible.
            </p>
          </div>
      ...
      {/* Team Section - Premium Slider Style */}
                  ...
                  <div key={index} className="w-full flex-shrink-0">
                    <div className="bg-white p-10 rounded-2xl shadow-xl border border-gray-100 transition-transform duration-300 hover:-translate-y-1">
                      <div className="w-16 h-16 mx-auto mb-6 bg-red-50 rounded-full flex items-center justify-center">
                        <span className="text-4xl font-serif text-red-600">
                          "
                        </span>
                      </div>
                      ...
                      <p className="text-gray-700 mb-8 text-lg text-center italic">
                        "{testimonial.text}"
                      </p>
      ...
      <div className="bg-gradient-to-r from-red-700 to-red-500 py-16 rounded-3xl mx-4 my-8 shadow-2xl overflow-hidden relative">
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl mx-auto">
            ...
            personalized, convenient healthcare.
          </p>
