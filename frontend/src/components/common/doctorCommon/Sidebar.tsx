...
export const Sidebar: React.FC<SidebarProps> = ({ onCollapse }) => {
    ...
    const fetchDoctorProfile = async () => {
      if (doctorId) {
        try {
          ...
          setIsDoctor(response.data?.data?.profile?.isDoctor);
        } catch (error) {
  ...
  const navItems: NavItem[] = [
    { icon: <LayoutGrid />, label: "Dashboard", path: "/doctor/home" },
    { icon: <User />, label: "Profile", path: "/doctor/profile" },
    { icon: <Calendar />, label: "Appointments", path: "/doctor/appointments" },
    { icon: <Clock />, label: "Current Schedules", path: "/doctor/schedules" },
    { icon: <GraduationCap />, label: "Qualification", path: "/doctor/qualifications" },
    { icon: <Wallet />, label: "Wallet", path: "/doctor/wallet" },
    { icon: <MessageSquare />, label: "Chats", path: "/doctor/chats" },
  ];
