...
const VerificationModal: React.FC<VerificationModalProps> = ({
  ...
  const fileUrl = certificates[currentCertIndex];
        ...
        <div className="p-4 md:p-6">
          <div className="mb-4">
            {certificates.length > 0 ? (
              <div className="relative overflow-hidden rounded-lg border border-gray-300 shadow-inner flex items-center justify-center min-h-[350px] bg-white">
                <CertificateViewer url={fileUrl} />
